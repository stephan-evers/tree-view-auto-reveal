...
export default {
  ...
  activate () {
    let disposables = this.disposables.disposables.size
    if (disposables !== 0) return
    ...
    this.disposables.add(dock.onDidChangeVisible(dockVisible))
